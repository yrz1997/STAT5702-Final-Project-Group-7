...
The last part focus on life expectancy and COVID-19. It uses data collect from the whole world. Life expectancy reflects the level of development of a country, or the proportion of the elderly population, the older the population. Therefore, the country with higher life expectancy generally will have a larger elderly population. So it is easier to combine COVID-19 with the elderly. Moreover, since two studies have reported that life expectancy has been shortened by nearly two years by 2020 as a result of 2019 corona virus disease. We make an analysis on the relationship between life expectancy and total number of cases per million population to find if the number of confirmed cases is positively correlated with the life expectancy.
