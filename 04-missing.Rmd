...
This is the missing value counts by different features. From this table, we can see that the feature “iso_code” , “location”  and “date” are comprehensive. But there are missing values in other features. However since comparing to the total number of records, the number of missing value in each feature is not too large, therefore, we choose to omit these observations.
